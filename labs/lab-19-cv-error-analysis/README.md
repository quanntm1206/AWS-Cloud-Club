# lab-19: CV error analysis

## Goal

Macro/per-class metrics, confusion matrix và tối đa 20 failure images; nếu ít hơn thì export toàn bộ và ghi count/limitation.
