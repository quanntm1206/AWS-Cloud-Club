...
echo "Assumptions: artifact <=50 MB stored 24h; <=100 Lambda invokes (private) at 512 MB/<=1s; <=5 MB logs; no public API."
...
echo "This is a planning envelope, not a live quote. STOP if you cannot verify current prices."
echo "Pricing checked 2026-08-12; recheck current S3, Lambda, CloudWatch Logs prices before every deploy."
echo "Sources: https://aws.amazon.com/s3/pricing/ https://aws.amazon.com/lambda/pricing/ https://aws.amazon.com/cloudwatch/pricing/ https://calculator.aws/"
